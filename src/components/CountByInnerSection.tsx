        ...
        if (numArr.length === 1) {
            if (firstNumber === value) {
                ...
                setTimeout(() => {
                    ...
                    numArr = String(newNumber + num).split("")
    ...
    return (
        <div className="App">
            ...
            <div className='gameBoxBottom'>
                ...
                <input type="text" inputMode="numeric" pattern="[0-9]*" maxLength={String(number + num).length} value={numberTyped} onChange={handleChange} />
            </div>
...
export default CountByInnerSection